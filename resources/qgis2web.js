...
map.getView().fit([-449956.663753, 4955657.735611, -442422.930620, 4960647.963347], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INVENTARIO_COLLADO (QFieldCloud)</h2>';
        return titleElement;
    })(),
